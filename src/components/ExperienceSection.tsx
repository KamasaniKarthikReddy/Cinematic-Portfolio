...
const journey: RouteStop[] = [
  {
    ...
    organization: 'INTELLECTION 2K25 (NATIONAL HACKATHON)',
    description: 'Secured Runner-Up at the National-Level Hackathon for architecting a decentralized Online Voting System built on blockchain security and AI anomaly verification.',
  },
  {
    id: '02',
    year: '2024',
    ...
    description: 'Selected as a National Finalist for solving real-time multilingual learning challenges with artificial intelligence and Google Cloud architectures.',
  },
  {
    id: '03',
    year: '2024',
    title: '1ST PLACE (OUT OF 500+ TEAMS)',
    organization: 'PROSLOVO PROBLEM FINDING HACKATHON',
    description: 'Awarded 1st Place among 500+ competing teams for identifying and formulating high-impact real-world problem statements through structured data analysis and innovation.',
  },
  {
    id: '04',
    year: '2024 - PRESENT',
    title: 'PROJECT TEAM LEAD',
    organization: 'ACADEMIC & HACKATHON TEAMS',
    description: 'Led cross-functional teams in designing and deploying full-stack and AI-driven platforms, managing sprint task distribution, code reviews, and pitch presentations.',
  },
  {
    id: '05',
    year: 'MULTIPLE WINS',
    title: 'PUBLIC SPEAKING & ELOCUTION WINNER',
    organization: 'INTER-COLLEGE & INTER-SCHOOL COMPETITIONS',
    description: 'Winner in numerous inter-collegiate and inter-school public speaking and elocution contests, demonstrating strong technical communication, pitching, and executive presence.',
  },
];
...
export const ExperienceSection: React.FC = () => {
  ...
  return (
    <section
      id="experience"
      ref={containerRef}
      className="relative w-full max-w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-4 pb-12 sm:pb-16 px-5 sm:px-12 lg:px-20 overflow-hidden"
    >
