...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      className="relative w-full max-w-full min-h-screen bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black py-16 sm:py-24 lg:py-32 px-5 sm:px-12 lg:px-20 overflow-hidden flex items-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-6 select-none">
              <h2
                className="text-4xl sm:text-6xl md:text-7xl lg:text-[5.4rem] tracking-tight uppercase leading-[0.9] sm:leading-[0.88]"
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">KARTHIK REDDY</span>, a Data Scientist and Data Analyst specializing in exploratory data analysis, statistical modeling, machine learning pipelines, and translating raw data into impactful business intelligence. With a strong mathematical foundation and a focus on clean analytical rigor, I turn complex datasets into actionable insights and strategic solutions.
            </motion.p>
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            <motion.div
              ...
              className="relative p-3 border border-[#8C6D4F]/40 rounded-sm bg-[#120F0C]/80 backdrop-blur-xl shadow-[0_25px_70px_rgba(0,0,0,0.95)] cursor-pointer group transition-colors duration-500 hover:border-[#D4AF37]/80"
            >
              {/* Locked Corner Gold Accent Brackets (Single Proper Frame) */}
              ...
              <div className="relative overflow-hidden w-full max-w-[380px] aspect-[4/5] bg-black rounded-[1px]">
                {/* Main Portrait */}
                <img
                  src={aboutImg}
                  alt="Karthik Reddy"
                  className="w-full h-full object-cover object-center scale-[1.26] filter brightness-[0.94] contrast-[1.06] saturate-[1.02] group-hover:brightness-105 group-hover:contrast-[1.12] transition-all duration-500 ease-out"
                />

                {/* Mouse-Tracked Holographic Glass Spotlight - Only lights up when cursor moves on the card */}
                <motion.div
