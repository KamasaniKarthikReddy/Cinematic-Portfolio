...
const bentoCategories = [
  {
    ...
    items: ['Python', 'scikit-learn', 'TensorFlow', 'NLP', 'Feature Engineering', 'Model Evaluation'],
    description: 'Developing predictive architectures, supervised/unsupervised machine learning pipelines, and NLP models with high evaluation metrics.',
    stat: 'PREDICTIVE AI',
  ...
  },
  {
    ...
    items: ['Pandas', 'NumPy', 'Power BI', 'Tableau', 'Matplotlib', 'Seaborn', 'EDA'],
    description: 'Exploratory Data Analysis (EDA), statistical hypothesis testing, executive business dashboards, and pattern discovery.',
    stat: 'ACTIONABLE INSIGHTS',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'SQL & DATA WAREHOUSING',
    badge: 'PIPELINES & STORAGE',
    items: ['SQL', 'PostgreSQL', 'MySQL', 'MongoDB Atlas', 'Data Wrangling', 'ETL'],
    description: 'Crafting complex SQL queries, aggregating multi-dimensional metrics, database schema design, and automated data pipelines.',
    stat: 'OPTIMIZED QUERIES',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'ALGORITHMS & STATISTICAL FOUNDATIONS',
    badge: 'MATHEMATICS & CORE',
    items: ['Python', 'C++', 'Java', 'Data Structures', 'Statistical Modeling', 'Probability'],
    description: '1200+ algorithmic and data structure problems solved. Grounded in probability distributions, multivariate statistics, and optimization.',
    stat: '1200+ SOLVED',
    colSpan: 'lg:col-span-7',
  },
];
...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="relative w-full max-w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 pb-20 sm:pb-24 px-5 sm:px-12 lg:px-20 overflow-hidden flex flex-col justify-center"
    >
      {/* Ambient Glows */}
