  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-end">
        ...
        <div className="absolute bottom-10 right-10 sm:bottom-14 sm:right-16 lg:bottom-16 lg:right-20 pointer-events-none flex items-center justify-center z-10">
          <div className="relative flex items-center justify-center">
            {/* Multi-layered dark occluding mask to completely blend out the underlying video watermark */}
            ...
            >
              <img
                src={watermarkImg}
                alt="Insignia"
                className="w-32 h-32 sm:w-36 sm:h-36 lg:w-40 lg:h-40 object-contain drop-shadow-[0_0_20px_rgba(212,175,55,0.35)]"
              />
            </motion.div>
          </div>
        </div>
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                DATA SCIENTIST <span className="text-[#8C6D4F] mx-1">•</span> DATA ANALYST <span className="text-[#8C6D4F] mx-1">•</span> MACHINE LEARNING
              </p>
            </motion.div>
